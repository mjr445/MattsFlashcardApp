...
### App Description
This is the third stage of the flashcard app. The user can now create a card and still see the created card upon relaunching the app. The user can also now cycle through the created cards.

### App Walk-though

<img src=http://g.recordit.co/vthdfc7Y9z.gif width=200><br>
